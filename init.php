...
/*Clases secundarias*/
include_once DIRECTORY_CLASS.'class.clientes.php';
include_once DIRECTORY_CLASS.'class.usuarios.php';
include_once DIRECTORY_CLASS.'class.graficas.php';
include_once DIRECTORY_CLASS.'class.sucursales.php';
include_once DIRECTORY_CLASS.'class.gerente.php';